...
//const int HEIGHT_CHANGE = 16;                               // height change in textures.png
const int HEIGHT_CHANGE = 16;                               // height change in textures3.png

const char TEXTURES_CUSTOM[] = "pictures\\land.png";
...
const UCHAR LMOUSE	     = VK_LBUTTON; // left mouse 
const UCHAR RMOUSE	     = VK_RBUTTON; // right mouse
